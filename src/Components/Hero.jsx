        ...
        <div className='bg-gradient-to-r from-white to-gray-300 relative '>/
            ...
            <div className='absolute top-0 left-0 '>
              ...
              <div className='absolute top-0 right-0 mr-64 transform -translate-x-64 translate-y-64'>
                  <div className='bg-gradient-to-br from-red-100 to-red-300 h-64 w-64 absolute rounded-full top-0 ml-10 opacity-20 hidden md:inline-block'></div>
                    <div className='bg-gradient-to-br from-teal-100 to-teal-300 h-64 w-64 absolute rounded-full top-0 ml-40 opacity-20 hidden md:inline-block'></div>
                    <div className='bg-gradient-to-br from-purple-100 to-purple-300 h-64 w-64 absolute rounded-full top-0 mt-14 ml-24 opacity-20 hidden md:inline-block'></div>
            </div>
            ...
            {/* heading */}
            <h1 className='mb-4 font-extrabold text-6xl p-3'>
            ...
            {/* paragraph */}
            <p className='mb-8 text-gray-700 text-2xl'>Make good looking desings quickly. All without a sing line of custom CSS. </p>

            <a href="#" className='mb-32 inline-block py-3  px-12 text-purple-100 font-bold shadow-xl rounded bg-gradient-to-br from-purple-400 to-purple-700 tracking-wide hover:to-purple-500 hover:shadow-2xl transition duration-500'>Pre-order available - Get the Course</a>

        
            <div className='relative'>
                 <img src="https://i.imgur.com/wysbBMS.png" alt="Teaser Image"className='rounded-lg shadow-2xl border-4 border-purple-400' />

                  <div className='absolute top-0 right-0 trasform translate-x-4 -translate-y-4 bg-yellow-50 border-t-2 border-yellow-500 p-3 text-sm text-left shadow-lg text-yellow-600 py-4 px-8 md:w-8/12 w-7/12 '>
